...
describe("package publishability", () => {
  ...
  it("ships the built output, README, the creator prompts, and the committed companion agents", () => {
    expect(pkg.files).toEqual(["dist", "README.md", "creators", "the-local/agents"]);
  });
